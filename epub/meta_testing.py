...
class MetaDataPropertyTest(unittest.TestCase):
    def setUp(self):
        self.meta = meta.MetaDataProperty(id="test-id", value="Test Value")
    ...
    def test_basic(self):
        ...
        xml = "<metadata>" "<default>Test Value</default>" "</metadata>"
        self.assertEqual(xml, str(self.parent))

    def test_id_only(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" '<default id="test-id">Test Value</default>' "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaPersonTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.id = None
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<person>John Doe</person>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaCollectionTest(unittest.TestCase):
    ...
    def test_collection(self):
        self.coll.collection = meta.Collection(
            id="other-id", identifier="identifier", value="Other Value"
        )
        self.coll.append_to_document(self.parent, self.soup)
        xml = (
            "<metadata>"
...
class MetaContributorTest(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        xml = "<metadata>" "<dc:contributor>John Doe</dc:contributor>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaCreatorTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.id = None
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:creator>John Doe</dc:creator>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaDateTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:date>1983-11-16T00:00:00</dc:date>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaFormatTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:format>application/epub+zip</dc:format>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaIdentifierTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.id = None
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:identifier>identifier</dc:identifier>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaLanguageTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:language>en-US</dc:language>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaPublisherTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:publisher>Test</dc:publisher>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaRelationTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:relation>Test</dc:relation>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaRightsTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:rights>Test</dc:rights>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaSourceTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:source>Test</dc:source>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaSubjectTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:subject>Test</dc:subject>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaTypeTest(unittest.TestCase):
    ...
    def test_basic(self):
        self.meta.append_to_document(self.parent, self.soup)
        xml = "<metadata>" "<dc:type>Test</dc:type>" "</metadata>"
        self.assertEqual(xml, str(self.parent))
...
class MetaDataTest(unittest.TestCase):
    def setUp(self):
        ...
        self.meta = meta.MetaData(
            identifiers=ids, languages=languages, titles=titles, modified=modified
        )
    ...
    def test_contributor(self):
        contributor = meta.Contributor(
            id="contributor-id", role="Illustrator", value="Bob"
        )
    ...
    def test_multiple_contributors(self):
        ...
        contributors = [
            meta.Contributor(value=value, role=role, id=id)
    ...
    def test_multiple_coverages(self):
        ...
        coverages = [
            meta.Coverage(value=value, id=_id) for value, _id in zip(values, ids)
        ]
    ...
    def test_major(self):
        ...
        self.meta.titles = [
            meta.Title(value="Dracula " "(Barnes & Noble Classics Series)", id=None)
        ]
