...
class ItemRefTest(unittest.TestCase):
    ...
    def test_item(self):
        ...
        xml = "<spine>" '<itemref idref="test-id"/>' "</spine>"
        self.assertEqual(xml, str(self.parent))

    def test_is_primary(self):
        self.itemref.is_primary = True
        self.itemref.append_to_document(self.parent, self.soup)
        xml = "<spine>" '<itemref idref="test-id" linear="yes"/>' "</spine>"
        self.assertEqual(xml, str(self.parent))

    def test_id(self):
        self.itemref.id = "ref-id"
        self.itemref.append_to_document(self.parent, self.soup)
        xml = "<spine>" '<itemref id="ref-id" idref="test-id"/>' "</spine>"
        self.assertEqual(xml, str(self.parent))
...
class TestManifest(unittest.TestCase):
    ...
    def test_with_items(self):
        ...
        self.manifest.items = [
            epub.Item(id=_id, href=href, media_type=media_type)
...
class ItemTest(unittest.TestCase):
    ...
    def test_fallback(self):
        self.item.fallback = epub.Item(
            id="fallback-id",
            href="Text/fallback.xhtml",
            media_type="application/xhtml+xml",
        )
        self.item.append_to_document(self.parent, self.soup)
        xml = (
